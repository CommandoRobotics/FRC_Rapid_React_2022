...
public class JogIndexRampReverseCommand extends CommandBase {
  
  IndexSubsystem indexSubsystem;

  /** Creates a new JogIndexRampReverseCommand. */
  public JogIndexRampReverseCommand(IndexSubsystem indexSubsystem) {
