...
public class RunIndexToShootAutoEndWithBreakCommand extends CommandBase {
  ...
  public RunIndexToShootAutoEndWithBreakCommand(IndexSubsystem indexSubsystem) {
  ...
  /** Creates a new RunVerticalToShootCommand. */
  public RunIndexToShootAutoEndWithBreakCommand(int numberOfBallsToShoot, IndexSubsystem indexSubsystem) {
    this.indexSubsystem = indexSubsystem;
  ...
  /** Creates a new RunVerticalToShootCommand. */
  public RunIndexToShootAutoEndWithBreakCommand(double maxTimeSeconds, int numberOfBallsToShoot, IndexSubsystem indexSubsystem) {
    this.indexSubsystem = indexSubsystem;
    timesBeamNeedsToBeBroken = numberOfBallsToShoot;
    addRequirements(indexSubsystem);
    timer = new Timer();
